...
exports.todosRouter.put("/update-todo/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const db = yield mongodb_1.client.db("todosDB");
    const todosCollection = yield db.collection("todos");
    const updateTodo = yield todosCollection.updateOne(filter, { $set: { title, description, priority, isCompleted } }, { upsert: true });
    res.json(updateTodo);
}));
// Delete todo
exports.todosRouter.delete("/delete-todo/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const db = yield mongodb_1.client.db("todosDB");
    const todosCollection = yield db.collection("todos");
    yield todosCollection.deleteOne({ _id: new mongodb_2.ObjectId(id) });
